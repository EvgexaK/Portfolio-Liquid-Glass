...
function initLanguageSwitcher() {
    ...
    const translations = {
        en: {
            ...
            "timeline.2023.text": "Developed a turn-based board game \"Expedition to Kola: Way Home\", which won the regional competition \"Souvenir of the Year. Arctic 2023\".",
            "timeline.2023.check1": "🎲 Developed design for maps, cards, and locations",
            ...
            "timeline.2018.text": "Teaching Assistant at Murmansk Arctic University (MAU) for an IT Startup course (Practical Work). Conducted deep analysis of students' business plans, provided consultations, and helped improve their projects.",
            "timeline.2018.check1": "🎓 Teaching Assistant for IT Startup course at MAU (Jul - Dec 2018)",
            "timeline.2018.check2": "📊 Deep analysis of student business plans",
            "timeline.2018.check3": "💬 Mentored and consulted groups to improve IT projects",
            "timeline.2018.check4": "🏆 Extended practical work for university credits",
            "timeline.uni.text": "Graduated from Lapland University of Applied Sciences (Finland). Bachelor of Business Administration — Business Information Technology specialization. Thesis on Self-Driving Vehicles.",
            "timeline.uni.check1": "🎓 Lapland UAS — BBA, Business Information Technology",
            "timeline.uni.check2": "🤖 Thesis on Self-Driving Vehicles (academic English)",
            "contact.title": "Get in Touch",
            "contact.text": "Interested in working together or have a project in mind? Let's talk.",
            "contact.email": "Email",
            "contact.phone": "+7 (953) 302-32-52",
            "about.cta.title": "Interested to work with me?",
        ...
        ru: {
            ...
            "timeline.title": "Мой профессиональный путь",
            ...
            "timeline.2023.text": "Совместно с коллегами разработал пошаговую настольную игру «Экспедиция на Кольский: путь домой», которая победила на областном конкурсе Мурманской области «Сувенир года. Арктика 2023».",
            "timeline.2023.check1": "🎲 Разработал дизайн карточек, самой карты и локаций",
            "timeline.2021.text": "Дизайнер в ООО «Телесеть» (группа компаний «ФосАгро»). Доверяли самые масштабные проекты от крупных заказчиков. Разрабатывал плакаты по информационной безопасности для сотрудников «ФосАгро».",
            ...
            "timeline.2018.text": "Помощник преподавателя в Мурманском Арктическом Университете (МАУ) на курсе по ИТ-стартапам (практическая работа). Проводил глубокий анализ бизнес-планов студенческих групп, давал консультации и помогал улучшать их проекты.",
            "timeline.2018.check1": "🎓 Помощник преподавателя на курсе по ИТ-стартапам в МАУ (Июль - Дек 2018)",
            "timeline.2018.check2": "📊 Глубокий анализ бизнес-планов студентов",
            "timeline.2018.check3": "💬 Менторство и помощь группам в улучшении ИТ-проектов",
            "timeline.2018.check4": "🏆 Расширенная практическая работа за дополнительные кредиты в университете",
            "timeline.uni.text": "Окончил Lapland University of Applied Sciences (Финляндия). Бакалавр делового администрирования — специализация Business Information Technology. Дипломная работа по беспилотным автомобилям.",
            "timeline.uni.check1": "🎓 Lapland UAS — BBA, Business Information Technology",
            "timeline.uni.check2": "🤖 Дипломная работа по беспилотным автомобилям (академический английский)",
            "contact.title": "Связаться",
            "contact.text": "Заинтересованы в сотрудничестве или есть проект? Давайте обсудим.",
            "contact.phone": "+7 (953) 302-32-52",
            "contact.email": "Email",
            "about.cta.title": "Интересно поработать со мной?",
            "about.cta.button": "Связаться со мной",
            "nav.home": "Главная",
            "nav.works": "Работы",
            "nav.about": "Инфо",
